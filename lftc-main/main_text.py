...
from compressorsself.compressorclassifier import CompressorClassifier
from compressorsself.zstdcompressorself import self_adaption
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="data\\datasets\\kirnews")
    parser.add_argument("--dataset", default="kirnews", help="<AG_NEWS, SogouNews, 20News, Ohsumed_single, R8, R52, kinnews, kirnews, swahili> [Note that for small datasets like kinnews, default 100-shot is too big, need to set --num_test and --num_train.]")
    parser.add_argument("--num_test", type=int, default=5)
    parser.add_argument("--num_train", type=int, default=50)

    parser.add_argument("--all_test", action="store_true", default=True)
    parser.add_argument("--all_train", action="store_true", default=True)
    parser.add_argument("--para", action="store_true", default=True)
    parser.add_argument(
        "--record",
        action="store_true",
        default=False,
